...
(function() {
	...
	function init() {
		...
		var revH1 = new RevealFx(document.querySelector('#rev-heading-1'), {
			revealSettings : {
				bgcolor: '#4f49ff',
		...
		var revH2 = new RevealFx(document.querySelector('#rev-heading-2'), {
			revealSettings : {
				bgcolor: '#202025',
				delay: 250,
				onCover: function(contentEl, revealerEl) {
		...
		var revH3 = new RevealFx(document.querySelector('#rev-heading-3'), {
			revealSettings : {
				bgcolor: '#4f49ff',
				delay: 500,
				onCover: function(contentEl, revealerEl) {
		...
		var rev15 = new RevealFx(document.querySelector('#rev-20')),
